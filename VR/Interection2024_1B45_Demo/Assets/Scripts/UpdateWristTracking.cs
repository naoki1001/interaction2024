...
public class UpdateWristTracking : MonoBehaviour
{
    [SerializeField] Transform leftHandAnchor, rightHandAnchor, leftWrist, rightWrist;
    ...
    void Update()
    {
        ...
        if (receivedTrackingData != null)
        {
            if (receivedTrackingData.wrist_position_l != null && receivedTrackingData.wrist_rotation_l != null)
            {
                ...
                {
                    leftWrist.position = receivedTrackingData.wrist_position_l;
                }
                if (receivedTrackingData.wrist_rotation_l != Quaternion.identity)
                {
                    leftWrist.rotation = receivedTrackingData.wrist_rotation_l;
                }
            }
            ...
            if (receivedTrackingData.wrist_position_r != null && receivedTrackingData.wrist_rotation_r != null)
            {
                ...
                {
                    rightWrist.position = receivedTrackingData.wrist_position_r;
                }
                if (receivedTrackingData.wrist_rotation_r != Quaternion.identity)
                {
                    rightWrist.rotation = receivedTrackingData.wrist_rotation_r;
                }
            }
        }
